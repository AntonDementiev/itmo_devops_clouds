...
#  Azure VM (Compute)
- **Описание**:
Azure Media Services — это сервис, который позволяет создавать и запускать виртуальные машины в облаке. С его помощью можно размещать в облачной среде приложения и системы на операционных системах Windows и Linux.
