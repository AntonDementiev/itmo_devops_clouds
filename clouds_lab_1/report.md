...
![image](https://github.com/user-attachments/assets/9b06f86c-a0ae-4370-b14d-d372f2c54b30)


2. Заполним 5 столбцов таблицы, используя данные на [официальном сайте](https://aws.amazon.com):

   ![image](https://github.com/user-attachments/assets/cb7425be-b091-4329-96cb-d1c995f10463)

   
Вот сервисы, которые были использованы в рамках лабораторной работы:

### AmazonElastiCache - Compute
- сервис повышает производительность веб-приложений (используя управляемые кеши в памяти).
Сервис в нашей лабораторной: `Tax` - налоги за использование; `Node Usage` - оплата за кеш-нод; 'Snapshot Creation' - создание резервных копий; `Backup Usage` - использование бэкапов.
...
- это сеть доставки контента, обеспечивающая быструю и безопасную передачу данных.
